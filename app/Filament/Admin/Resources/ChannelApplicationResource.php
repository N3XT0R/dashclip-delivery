...
class ChannelApplicationResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\ChannelApplicationResource\Pages\ListChannelApplications::route(
                '/'
            ),
            'edit' => \App\Filament\Admin\Resources\ChannelApplicationResource\Pages\EditChannelApplication::route(
                '/{record}/edit'
            ),
        ];
    }
