...
class ShieldSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $directPermissions = '{"297":{"name":"manage_channels:_team","guard_name":"standard"},"298":{"name":"manage_channels:_team","guard_name":"web"},"372":{"name":"View:BaseChannelWidget","guard_name":"standard"}}';
