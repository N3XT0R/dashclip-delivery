...
return [
    'notifications' => [
        'started' => [
            ...
            'body' => '1 Video wird gepackt. Du erhältst eine Benachrichtigung, sobald die ZIP-Datei bereit ist.|:count Videos werden gepackt. Du erhältst eine Benachrichtigung, sobald die ZIP-Datei bereit ist.',
        ],
    ],
];
```
