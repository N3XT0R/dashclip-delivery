@php
    ...
    $iconColor = match ($getIconColor()) {
        ...
        'info' => 'text-info-500',
        default => 'text-white dark:text-grey-400',
    };

    $iconClasses = "fi-wi-stats-overview-stat-icon h-8 w-8 {$iconColor}";
    $iconBackgroundColor = $iconHasBackgroundColor() ? $getIconBackgroundColor() : '';

    $iconContainerClasses = "h-fit p-1 rounded-lg";
    $iconContainerStyles = "background-color: {$iconBackgroundColor};";
