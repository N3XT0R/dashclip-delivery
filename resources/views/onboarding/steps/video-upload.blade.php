...
### Was danach passiert
- ⚙️ Das System verarbeitet dein Video und führt automatisch einen **Duplikat-Check** aus.
- 🔔 Du erhältst Benachrichtigungen, sobald das Video bereit ist oder zusätzliche Infos benötigt.
...
### Nächste Schritte
Sobald dein Video verarbeitet ist, kannst du es direkt Kanälen zuordnen oder später unter `Videos` auswählen, um weitere Details festzulegen.
