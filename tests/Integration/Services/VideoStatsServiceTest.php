...
class VideoStatsServiceTest extends DatabaseTestCase
{
    ...
    public function testGetVideoStatsReturnsCorrectStat(): void
    {
        ...
        // 3 Videos mit je einem Clip des Users
        Video::factory()->count(3)->withClips(1, $user)->create();
    ...
    public function testAvailableOffersStats(): void
    {
        ...
        Assignment::factory()->create([
            ...
            'batch_id' => $batch->id,
            'status' => $readyStatus,
            'expires_at' => now()->addDay(), // darf nicht abgelaufen sein
        ]);
