...
{
    public function testEditActionVisibleForAuthorizedUser(): void
    {
        ...
        Livewire::test(ViewChannel::class, ['record' => $channel->getKey()])
            ->assertStatus(200)
            ->assertActionVisible('edit');
    }

    public function testUnauthorizedUserCannotAccessViewPage(): void
    {
        $channel = Channel::factory()->create();
