...
namespace Tests\Integration\Filament\Admin\Resources\Batches\RelationManagers;

use App\Enum\BatchTypeEnum;
use App\Filament\Admin\Resources\Batches\Pages\ViewBatch;
use App\Filament\Admin\Resources\Batches\RelationManagers\ClipsRelationManager;
...
final class ClipsRelationManagerTest extends DatabaseTestCase
{
    ...
    public function testClipsRelationManagerRendersForAdmin(): void
    {
        ...
        Livewire::test(ClipsRelationManager::class, [
            'ownerRecord' => $batch,
            'pageClass' => ViewBatch::class, // <- Wichtig!
        ])
            ->assertSuccessful()
